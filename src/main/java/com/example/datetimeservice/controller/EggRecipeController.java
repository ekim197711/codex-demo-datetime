...
import com.example.datetimeservice.service.EggRecipeService;
...
public class EggRecipeController { // bad: class lacks JavaDoc and naming clarity, making intent unclear
    ...
    @GetMapping("/api/eggs/recipe")
    // bad: hard-coded string path without constants or versioning creates brittle endpoints
    public Object getRandomEggRecipe() { // bad: returning Object loses type safety and complicates serialization
        ...
        return null; // bad: returning framework-managed map prevents explicit ResponseEntity control and headers
